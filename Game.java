...
public class Game {
	...
	ImageIcon endbutton = new ImageIcon("src/buttons1.png");	//끝내기, 계속하기, 
	ImageIcon endbutton_end = new ImageIcon("src/buttons2.png");// 랭킹보기 옵션
	...
	ImageIcon BackStop = new ImageIcon("src/stopimage.png");
	
	


	PosImageIcon startButton = new PosImageIcon("src/gamestart3", 0, 0, 100, 50);
	PosImageIcon startButtonPressed = new PosImageIcon("src/gamestart4",0,0,100,50);
...
/*****************************제작자 - 순천향대학교 의료IT공학과 박정훈 **********************/
	...
	private class ClockListener implements ActionListener {
		...
		public void actionPerformed (ActionEvent event) {		 //다시보기
			ScoreTime+=35;
